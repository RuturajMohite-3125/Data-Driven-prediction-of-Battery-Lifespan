"""
Config sweep: 6 cycle windows × 5 CNN-GRU configs × 10 seeds.
...
Usage:
    python run_cnn_gru_config_sweep.py
    python run_cnn_gru_config_sweep.py --configs A B --windows 0 3
    python run_cnn_gru_config_sweep.py --out results.json
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="CNN-GRU sweep: cycle windows × configs × seeds"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--out", default="cnn_gru_sweep_results.json",
        help="JSON output path (default: cnn_gru_sweep_results.json)"
    )
